...
`docs/solutions/` contains searchable records of past bugs and implementation guidance, organized by topic with YAML frontmatter. It is relevant when implementing or debugging in documented areas.
